...
% 1. LaTeX Vorlage von Nikolas von Lüpke, Version 1.1
%==================================================================================================================%
% Textencoding: 8859-1
\documentclass[
a4paper,
...
\usepackage{tabularx}
\usepackage{multirow}
\usepackage{graphicx} %Mit diesem package können pdf,png und jpg Graphiken eingelesen werden und direkt pdfs erzeugt werden
%\usepackage{picins}
%\usepackage{subfig}
...
%% ------------------------------ Artikel 1 R-Package-------------------------------------------------- %%
\input{Rpackage_Article/Rpackage_forestinventory}
	\clearpage
	\newpage
	\mbox{}
	\pagebreak
...
\input{Regmodel_Article/regmod_article}
	\clearpage
	\newpage
	\mbox{}
	\pagebreak
...
%%% ------------------------------ Artikel 4 Mapping -------------------------------------------------- %%
\input{Mapping_Article/mapping_article}
\clearpage
\newpage
\mbox{}
\pagebreak
