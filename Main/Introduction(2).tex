...
\setchapterpreamble[uc][0.8\textwidth]{%
			\dictum[Hans Schreuder, Timothy Gregoire, Geoffrey Wood \\ \textit{Sampling Methods for Multisource Forest Inventory}]{%
				``Statistics should be an aid to common sense and it is not surprising that practitioners sometimes develop sound and reasonable methods before theoreticians do.''}\vskip20em}
