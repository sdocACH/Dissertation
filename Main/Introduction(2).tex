...
A groundbreaking invention in sampling methodology that came up in the 1930s and decisively shaped today's forest inventories was double-sampling. The major difference to the existing methods was that in order to derive estimates, double-sampling allowed to include information derived from two samples (so-called \textit{phases}) of different sampling frequencies. This was of particular advantage in cases where gathering the target variable of interest was considerably cost-intensive, and less precise but cheap information related to the target variable (so-called \textit{auxiliary information}) was available in high quantity in the estimation domain. The collection of the cost-intensive information could thus be restricted to a small sample, and estimation precision could then be boosted by combining this information with a large sample of explanatory variables derived from the auxiliary information. First studies that introduced this technique were those of \citet{neyman1938}, who applied double-sampling for stratification in the field of census statistics, and \citet{watson1937} who used double-sampling for regression to estimate the leaf area in field crops. It did not take a long time until double-sampling was applied to forest inventories. According to \citet{kangas2006}, the first study was conducted in the USA by \citet{bickford1952, bickford1953} who used double-sampling to estimate total timber volume by combining classification of forest area based on aerial images with terrestrial field measurements. The use of aerial imagery to increase the efficiency of forest inventories, however, date back to around 1910 in Germany \citep{zoehrer1980} and 1920 in Canada and the USA \citep{langballe1938}. Whereas these aerial images were used for ....., the introduction of double-sampling considerably extended their area of application to .... . The derivation of information from aerial photos had. however, long been conducted by visual interpretation (mention schmid-hass, still applied in recent inventories such as in Switzerland). Whereas the visual interpretation were much cheaper than field measurements, the ... breakthrough came with the possibility to automatically derive explanatory variables, together with [new remote sensing sources].
