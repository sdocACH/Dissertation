...
%
% - The investigated DESIGN-BASED small area regression estimators show great potential for the German NFI data to be additionally used 
%   for estimation of forest attributes on forest district level. In a first case study presented in this thesis, the variance for the estimation of timber volume was reduced by 43\% and 25\% on average compared to the one-phase estimator exclusively using the terrestrial data, resulting in estimation errors of 5\% and 11\% on average respectively.
